...
$$F\texttt{-}Measure = 2*\frac{Precision * Recall}{Precision + Recall}$$
...
Welch's T-Test --- an adaptation of Student's T-Test intended to test the null hypothesis that the two population means (in our case, average F-measures) are equal. Welch's variant of the T-Test is used when two samples are having possibly unequal variances~\cite{Welch:1947}.
